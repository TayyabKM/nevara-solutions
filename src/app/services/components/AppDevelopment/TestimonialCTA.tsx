  ...
  return (
    ...
    >
      <blockquote className="text-xl md:text-2xl italic max-w-2xl mx-auto">
        "Nevara Solutions built an app that exceeded our expectations. The UI/UX is intuitive, and the performance is flawless!"
      </blockquote>
      <p className="mt-4 font-semibold text-lg">- Qibla Schools</p>
