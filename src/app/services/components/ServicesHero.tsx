...
export default function ServicesHero() {
    ...
    pt-0 md:pt-[130px]"  // ✅ Added top padding for larger screens
                ...
                >
                    ...
                    {/* Title */}
                    <motion.div
                        className="text-center font-bold text-black dark:text-white leading-tight"
                    >
                        {/* First Line */}
                    ...
                    {/* Subheading */}
                    <motion.h2
                        className="mt-4 text-lg md:text-2xl lg:text-3xl font-semibold text-black dark:text-white text-center whitespace-nowrap"
                    >
