    ...
    <section className="relative w-full h-screen flex items-center justify-center text-center px-6">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full px-6 pb-20">
        ...
        >
          ...
          Whether you&apos;re a startup, an e-commerce brand, or a corporate giant, we build websites that deliver tangible results. — serving clients worldwide, including the Middle East, Europe, and North America.
        </motion.p>
      </div>
    </section>
  );
