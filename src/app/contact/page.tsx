    ...
    <div className="relative py-32 px-6 md:px-12 lg:px-24 flex flex-col items-center">
      ...
      >
        ...
        <p className="mt-4 text-gray-600 dark:text-gray-400 text-lg">
          Tell us about your project. Let’s see how we can help!
        </p>
      </motion.div>
      ...
      >
        ...
        <div className="col-span-2">
          <PhoneInput
            ...
            className="w-full"
            inputClassName="w-full !bg-gray-900 !text-gray-200 p-3 rounded-md border border-gray-700 focus:ring-0 focus:shadow-[0_0_12px] focus:shadow-blue-500/50 focus:bg-gradient-to-r focus:from-blue-500 focus:to-purple-500"
            buttonClassName="!bg-gray-900 !text-gray-200 border-gray-700"
            dropdownClassName="!bg-gray-800 !text-gray-200 border-gray-700"
            style={{
...
function ContactOptions() {
  return (
    <motion.div className="flex flex-col gap-6 text-gray-700 dark:text-gray-300" initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
...
function ContactInfo({ icon, label, value, link }: { icon: string; label: string; value: string; link?: string }) {
  return (
    <motion.div className="flex items-center gap-4" initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.3 }}>
